  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: animal.dono.login == usuario.usuario.login
            ? [
                IconButton(
                    onPressed: () {
                      Navigator.of(context)
                          .pushNamed(AppRoutes.FORM_ANIMAL, arguments: animal);
                    },
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      Provider.of<AnimaisRepository>(context,
                                              listen: false)
                                          .removeAnimal(animal);
                                      Provider.of<UsuarioRepository>(context,
                                              listen: false)
                                          .removeMeusAnimais(animal);
                                      Provider.of<AdocoesRepository>(context,
                                              listen: false)
                                          .deleteAdocaoByAnimal(animal);
      ...
      bottomSheet: animal.dono.login !=
              usuario
                  .usuario.login // Quem entrou na página não adicionou o animal
          ? !adocoes.inUserAdocoes(
                  animal,
                  usuario.usuario
                      .login) // Usuario já esta em processo de adocao desse animal
              ? ElevatedButton(
                  style: ButtonStyle(
                    ...
                    if (usuario.usuario.login == '') {
                      showDialog(
                          ...
                          builder: (BuildContext context) => AlertDialog(
                                ...
                                content: Text(
                                    'Para adotar um animal você deve estar logado no sistema...'),
                                actions: [
                                  TextButton(
                                    onPressed: () => Navigator.pop(context),
                                    child: const Text(
                  ...
                  onPressed: () {
                    var adocao =
                        Provider.of<AdocoesRepository>(context, listen: false)
                            .findByAnimal(animal);
                    Navigator.of(context).pushNamed(AppRoutes.ADOCAO_DETAIL,
                        arguments: adocao[0]);
                  },
                  child: SizedBox(
                    height: 50,
          ...
          : ElevatedButton(
              ...
              onPressed: () {
                Navigator.of(context)
                    .pushNamed(AppRoutes.ADOCAO_UNIQUE, arguments: animal);
              },
              child: SizedBox(
                height: 50,
                child: Center(
